...
class CipherSuite private constructor(
    ...
    companion object {
        ...
        @JvmField
        val TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA =
        ...
        @JvmField
        val TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 =
        ...
        @JvmField
        val TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 =
            init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", 0x006b)
        @JvmField
        val TLS_DH_anon_WITH_AES_128_CBC_SHA256 =
            init("TLS_DH_anon_WITH_AES_128_CBC_SHA256", 0x006c)
        @JvmField
        val TLS_DH_anon_WITH_AES_256_CBC_SHA256 =
        ...
        @JvmField
        val TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 =
            init("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", 0x00a2)
        @JvmField
        val TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 =
        ...
        @JvmField
        val TLS_DH_anon_WITH_AES_128_GCM_SHA256 =
        ...
        @JvmField
        val TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA =
            init("TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA", 0xc003)
        @JvmField
        val TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA =
            init("TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA", 0xc004)
        @JvmField
        val TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA =
        ...
        @JvmField
        val TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA =
        ...
        @JvmField
        val TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256 =
            init("TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256", 0xc029)
        @JvmField
        val TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384 =
        ...
        @JvmField
        val TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256 =
            init("TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256", 0xc031)
        @JvmField
        val TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384 =
